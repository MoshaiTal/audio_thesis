...
class MultiResUnet(torch.nn.Module):
    ...
    def __init__(self, input_channels, num_classes, alpha=1.67):
        ...
        self.head_decoders = nn.ModuleList([
            DecoderBlock(self.in_filters5, num_classes, alpha)
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        outputs = [decoder(x_multires5, x_multires4, x_multires3, x_multires2, x_multires1) for decoder in self.head_decoders]
