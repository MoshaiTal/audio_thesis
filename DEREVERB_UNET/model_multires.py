...
class MultiResUnet(torch.nn.Module):
    ...
    def __init__(self, input_channels, num_classes, alpha=1.67):
        ...
        self.conv_finala = Conv2d_batchnorm(self.in_filters9, num_classes + 1, kernel_size=(1, 1), activation='None')
        self.conv_finalb = Conv2d_batchnorm(self.in_filters9, num_classes + 1, kernel_size=(1, 1), activation='None')
        self.conv_finalc = Conv2d_batchnorm(self.in_filters9, num_classes + 1, kernel_size=(1, 1), activation='None')
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        outa,outb,outc = self.conv_finala(x_multires9),self.conv_finalb(x_multires9),self.conv_finalc(x_multires9)
