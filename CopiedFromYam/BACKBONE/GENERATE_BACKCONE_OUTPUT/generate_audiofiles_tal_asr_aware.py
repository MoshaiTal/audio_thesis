...
from CopiedFromYam.BACKBONE.MODEL_SECTION.training_page_same_alpha_asr_aware import evaluate_individual_heads
...
def make_out_roots(cfg: dict):
    ...
    tag = OUTPUT_TAG_OVERRIDE or cfg["General"].get("OUTPUT_TAG", "") or calib_name or "none"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Output folder tag. If set, files go to dereverb_rec/spec/mel/calibrated_<output_tag>. "
            "This is separate from CALIB_NAME, so you can keep CALIB_NAME=rcps while avoiding overwrites."
        ),
    )
